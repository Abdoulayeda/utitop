                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-500 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 py-3">Nombre de clients</th>
                            ...
                            <tbody>
                               ...
                               <tr class="border-b dark:border-gray-700">
                                    ...
                                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $commerciale->email }}</th>
                                   
                                    <td class="px-4 py-3">{{ count($commerciale->clients) }} </td>
                                    ...
                                    <td class="px-6 py-4 text-red-800">
                                        <form action="{{-- route('formule.delete', $formule->id) --}}" method="post">
                                            @csrf
                                            @method('delete')
                                               <button type="submit" >
