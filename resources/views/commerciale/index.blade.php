...
@section('content')
    <div class="sm:ml-64 bg-orange-400 h-screen">
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mx-6 py-6">
            <div class="shadow-lg hover:shadow-2xl bg-white rounded-lg flex p-4 flex-col justify-center items-center">
                <span class="text-4xl font-bold text-orange-500">{{ count($user->clients) }}</span>
            ...
            <div class="shadow-lg hover:shadow-2xl bg-white rounded-lg flex p-4 flex-col justify-center items-center">
                <span class="text-4xl font-bold text-orange-500">{{ count($user->clients) - count($clients_aa) }}</span>
                <span class="text-3xl font-bold">Abonnement</span>
